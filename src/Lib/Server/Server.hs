...
view env win translation eGrades eLocationConfigFile eSessions eShootings eCameras eDump eDumpDir bDoneshooting bDagsdato bDagsdatoBackup bPhotographers tabs = do
